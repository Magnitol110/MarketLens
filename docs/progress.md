...
| DATA-02 | Select and clean MSFT history | Artem | Done | `data/processed/msft_daily.csv` | 10,161 rows; 1986-03-13 to 2026-07-14 |
| DATA-03 | Add SPY benchmark and align dates | Artem | Done | `data/processed/msft_spy_daily.csv` | 2,512 aligned rows through 2026-07-14; no nulls or duplicate dates |
...
| ML-02 | Train price-only classification baseline | Artem | Done | `notebooks/02_baseline.ipynb`, `docs/baseline-metrics.json` | HistGradientBoosting validation macro F1 0.3412; test untouched |
